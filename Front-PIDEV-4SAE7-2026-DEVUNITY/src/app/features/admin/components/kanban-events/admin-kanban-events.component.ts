...
@Component({
  selector: 'app-admin-kanban-events',
  templateUrl: './admin-kanban-events.component.html',
  styleUrls: ['./admin-kanban-events.component.scss']
})
export class AdminKanbanEventsComponent implements OnInit, OnDestroy {
