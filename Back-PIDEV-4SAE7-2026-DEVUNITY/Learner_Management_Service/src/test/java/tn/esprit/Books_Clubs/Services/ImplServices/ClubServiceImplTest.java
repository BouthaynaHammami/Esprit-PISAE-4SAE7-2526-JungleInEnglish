...
import tn.esprit.Services.ImplServices.ClubServiceImpl;
...
class ClubServiceImplTest {
    ...
    void shouldReferenceTargetServiceClass() {
        assertEquals("ClubServiceImpl", ClubServiceImpl.class.getSimpleName());
    }

    @Test
    void shouldDeclareAtLeastOneNonSyntheticMethod() {
        long methodCount = java.util.Arrays.stream(ClubServiceImpl.class.getDeclaredMethods())
