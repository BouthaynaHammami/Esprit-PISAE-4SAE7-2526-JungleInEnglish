...
class BusinessEnglishPathServiceImplTest {

    @Test
    void shouldReferenceTargetServiceClass() {
        assertEquals("BusinessEnglishPathServiceImpl", BusinessEnglishPathServiceImpl.class.getSimpleName());
    }

    @Test
    void shouldDeclareAtLeastOneNonSyntheticMethod() {
        long methodCount = java.util.Arrays.stream(BusinessEnglishPathServiceImpl.class.getDeclaredMethods())
